...
struct L3IAPacketAssignment : GenericMessageElement {
	...
	Field_z<4> mAlpha;
	Bool_z mAlphaPresent; // optional param
	Field_z<5> mGamma;

	Field_z<4> mTimingAdvanceIndex;
	Bool_z mTimingAdvanceIndexPresent; // optional param
	...
	Field_z<16> mTBFStartingTime;
	Bool_z mTBFStartingTimePresent;   // optional param
