...
public:
	...
	fusb_ephandle *make_ephandle(int endpoint, bool input_p, int block_size = 0, int nblocks = 0);
...
public:
	fusb_ephandle(fusb_devhandle *dh, int endpoint, bool input_p, int block_size = 0, int nblocks = 0);
	~fusb_ephandle();
	...
	fusb_devhandle *get_fusb_devhandle() const { return d_devhandle; }
