/* TransceiverRAD1/sigProcLibTest.cpp */
/*-
...
int main(int argc, char **argv)
{
	...
	signalVector *modBurst = modulateBurst(normalBurst, *gsmPulse, 0, samplesPerSymbol);
