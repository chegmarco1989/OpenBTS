/* TransceiverRAD1/radioInterface.h */
/*-
...
public:
	/** constructor */
	radioVector(const signalVector &wVector, GSM::Time &wTime, int wARFCN)
		: signalVector(wVector), mTime(wTime), mARFCN(wARFCN){};
...
public:
	...
	RadioInterface(RadioDevice *wRadio = NULL, int receiveOffset = 3, int wRadioOversampling = SAMPSPERSYM,
		int wTransceiverOversampling = SAMPSPERSYM, bool wLoadTest = false, unsigned int wNumARFCNS = 1,
